...
public class UserTestReview extends JFrame {
	...
	void createQ(TestContentDTO dto, String userAnswer) {
        ...
        //JLabel lblAnswer = new JLabel("정답 : " + dto.getAnswer());
		...
		if(dto.getAnswer().equals(userAnswer))
			...
			if(dto.getQ_form() == 0) {
				...
				JButton btnShowAnswer = new JButton("정답 보기");
				...
				btnShowAnswer.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						JOptionPane.showMessageDialog(null, dto.getAnswer(), "답", JOptionPane.PLAIN_MESSAGE);
					}
				});
